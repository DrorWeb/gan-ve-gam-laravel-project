    ...
    <div class="container">
    	...
    	<div class="componentWrapper">
             ...
             <div class="playerHolder">
                 ...
                 <!-- player logo -->
    	 		 <div class="playerLogo"><img src="{{ asset('images/kidsImages/ganLogo.png')}}" alt="logo" width="86" height=""/></div>
             ...
             <div class="playlistData">
                 ...
                 <ul id="playlist1" data-address="playlist1">
                     ...
                     <li data-address="local{{$num}}" 
                         class="playlistNonSelected" 
                         data-type="local" data-mp4Path="{{ asset( '/videos/' . $video['name'])}}" >
                         
                            <div class="playlistThumb">
                                <img class="thumb" src="{{ asset('images/misc/icon-2174711_640.png')}}" width="120" height="68" alt=""/> 
                            </div> 
                         <div class="playlistInfo"><p><span class="playlistTitle">Video title goes here</span><br>
                                 <span class="playlistContent">Vestibulum accumsan enim nec ipsum. Nunc cursus sapien. Commodo vitae, commodo in,</span></p></div>
                     </li>
