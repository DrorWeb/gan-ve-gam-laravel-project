...
<section id="events2" class="margin-top-60">
    ...
    <div class="container">
    	...
    	<div class="componentWrapper">
             ...
             <!-- playlist part -->
             <div class="playlistHolder" style="">
             ...
             <div class="playlistData">
                 ...
                 <ul id="playlist1" data-address="playlist1">
                     ...
                     <li data-address="local2" class="playlistNonSelected" data-type="local" data-mp4Path="{{ asset('media/video/1/main/02.mp4')}}" data-ogvPath="{{ asset('media/video/1/main/02.ogv')}}" data-webmPath="{{ asset('media/video/1/main/02.webm')}}" data-imagePath="{{ asset('media/video/1/main/02.jpg')}}" > <div class="playlistThumb"><img class="thumb" src="{{ asset('media/video/1/preview/02.jpg')}}" width="120" height="68" alt=""/> </div> <div class="playlistInfo"><p><span class="playlistTitle">Video title goes here</span><br><span class="playlistContent">Vestibulum accumsan enim nec ipsum. Nunc cursus sapien. Commodo vitae, commodo in,</span></p></div></li>
                     <li data-address="local3" class="playlistNonSelected" data-type="local" data-mp4Path="{{ asset('media/video/1/main/03.mp4')}}" data-ogvPath="{{ asset('media/video/1/main/03.ogv')}}" data-webmPath="{{ asset('media/video/1/main/03.webm')}}" data-imagePath="{{ asset('media/video/1/main/03.jpg')}}" > <div class="playlistThumb"><img class="thumb" src="{{ asset('media/video/1/preview/03.jpg')}}" width="120" height="68" alt=""/> </div> <div class="playlistInfo"><p><span class="playlistTitle">Video title goes here</span><br><span class="playlistContent">Sed commodo sapien rutrum nulla. Commodo vitae, commodo in, tempor eu, urna. Etiam</span></p></div></li>
                     <li data-address="local4" class="playlistNonSelected" data-type="local" data-mp4Path="{{ asset('media/video/1/main/04.mp4')}}" data-ogvPath="{{ asset('media/video/1/main/04.ogv')}}" data-webmPath="{{ asset('media/video/1/main/04.webm')}}" data-imagePath="{{ asset('media/video/1/main/04.jpg')}}" > <div class="playlistThumb"><img class="thumb" src="{{ asset('media/video/1/preview/04.jpg')}}" width="120" height="68" alt=""/> </div> <div class="playlistInfo"><p><span class="playlistTitle">Video title goes here</span><br><span class="playlistContent">Curabitur porta elementum arcu commodo in, tempor eu, urna. Etiam justo ipsum maec</span></p></div></li>
                     <li data-address="local5" class="playlistNonSelected" data-type="local" data-mp4Path="{{ asset('media/video/1/main/05.mp4')}}" data-ogvPath="{{ asset('media/video/1/main/05.ogv')}}" data-webmPath="{{ asset('media/video/1/main/05.webm')}}" data-imagePath="{{ asset('media/video/1/main/05.jpg')}}" > <div class="playlistThumb"><img class="thumb" src="{{ asset('media/video/1/preview/05.jpg')}}" width="120" height="68" alt=""/> </div> <div class="playlistInfo"><p><span class="playlistTitle">Video title goes here</span><br><span class="playlistContent">Integer tellus justo, commodo in, tempor eu, urna. Nunc vulputate est vitae lectus</span></p></div></li>
                     <li data-address="local6" class="playlistNonSelected" data-type="local" data-mp4Path="{{ asset('media/video/1/main/06.mp4')}}" data-ogvPath="{{ asset('media/video/1/main/06.ogv')}}" data-webmPath="{{ asset('media/video/1/main/06.webm')}}" data-imagePath="{{ asset('media/video/1/main/06.jpg')}}" > <div class="playlistThumb"><img class="thumb" src="{{ asset('media/video/1/preview/06.jpg')}}" width="120" height="68" alt=""/> </div> <div class="playlistInfo"><p><span class="playlistTitle">Video title goes here</span><br><span class="playlistContent">Donec vel sapien ultrices lorem laoreet viverra. Etiam justo ipsum maecenas nec te</span></p></div></li>
                     <li data-address="local7" class="playlistNonSelected" data-type="local" data-mp4Path="{{ asset('media/video/1/main/01.mp4')}}" data-ogvPath="{{ asset('media/video/1/main/07.ogv')}}" data-webmPath="{{ asset('media/video/1/main/07.webm')}}" data-imagePath="{{ asset('media/video/1/main/07.jpg')}}" > <div class="playlistThumb"><img class="thumb" src="{{ asset('media/video/1/preview/07.jpg')}}" width="120" height="68" alt=""/> </div> <div class="playlistInfo"><p><span class="playlistTitle">Video title goes here</span><br><span class="playlistContent">Maecenas eu erat condimentum neque molestie tincidunt. Etiam justo ipsum maecenas </span></p></div></li>
                     <li data-address="local8" class="playlistNonSelected" data-type="local" data-mp4Path="{{ asset('media/video/1/main/01.mp4')}}" data-ogvPath="{{ asset('media/video/1/main/01.ogv')}}" data-webmPath="{{ asset('media/video/1/main/01.webm')}}" data-imagePath="{{ asset('media/video/1/main/01.jpg')}}" > <div class="playlistThumb"><img class="thumb" src="{{ asset('media/video/1/preview/01.jpg')}}" width="120" height="68" alt=""/> </div> <div class="playlistInfo"><p><span class="playlistTitle">Video title goes here</span><br><span class="playlistContent">Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turp</span></p></div></li>
                     <li data-address="local9" class="playlistNonSelected" data-type="local" data-mp4Path="{{ asset('media/video/1/main/01.mp4')}}" data-ogvPath="{{ asset('media/video/1/main/02.ogv')}}" data-webmPath="{{ asset('media/video/1/main/02.webm')}}" data-imagePath="{{ asset('media/video/1/main/02.jpg')}}" > <div class="playlistThumb"><img class="thumb" src="{{ asset('media/video/1/preview/02.jpg')}}" width="120" height="68" alt=""/> </div> <div class="playlistInfo"><p><span class="playlistTitle">Video title goes here</span><br><span class="playlistContent">Commodo vitae, commodo in, tempor eu, urna. Etiam justo ipsum maecenas nec tellus.</span></p></div></li>
                 </ul>
...
<!--<script type="text/javascript" src="{{ asset('plugins/_deploy/js/soundmanager2-nodebug-jsmin.js')}}" ></script>-->
...
<script type="text/javascript" src="{{ asset('plugins/_deploy/js/jquery.selectbox-0.2.js')}}"></script>
